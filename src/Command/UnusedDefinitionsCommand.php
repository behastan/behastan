...
final class UnusedDefinitionsCommand extends Command
{
    ...
    public function __construct(SymfonyStyle $symfonyStyle, UnusedDefinitionsAnalyzer $unusedDefinitionsAnalyzer)
    {
    ...
    protected function configure(): void
    {
        ...
        $this->addArgument(Option::TEST_DIRECTORY, InputArgument::REQUIRED | InputArgument::IS_ARRAY, 'One or more paths to check or *.Context.php and feature.yml files');
    }
