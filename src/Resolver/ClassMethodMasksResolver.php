...
use Behastan202511\PhpParser\Comment\Doc;
...
final class ClassMethodMasksResolver
{
     ...
     * @var string[]
     */
    private const ATTRIBUTE_NAMES = ['Behastan202511\Behat\Step\Then', 'Behastan202511\Behat\Step\Given', 'Behastan202511\Behat\Step\And'];
    /**
     * @return string[]
     */
