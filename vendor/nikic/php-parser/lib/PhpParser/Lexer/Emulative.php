...
namespace Behastan202502\PhpParser\Lexer;

use Behastan202502\PhpParser\Error;
use Behastan202502\PhpParser\ErrorHandler;
use Behastan202502\PhpParser\Lexer;
use Behastan202502\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Behastan202502\PhpParser\Lexer\TokenEmulator\TokenEmulator;
