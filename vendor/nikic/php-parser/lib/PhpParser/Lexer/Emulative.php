...
namespace Behastan202511\PhpParser\Lexer;

use Behastan202511\PhpParser\Error;
use Behastan202511\PhpParser\ErrorHandler;
use Behastan202511\PhpParser\Lexer;
use Behastan202511\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Behastan202511\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Behastan202511\PhpParser\PhpVersion;
use Behastan202511\PhpParser\Token;
