...
use Behastan202511\PhpParser\Internal\DiffElem;
use Behastan202511\PhpParser\Internal\Differ;
use Behastan202511\PhpParser\Internal\PrintableNewAnonClassNode;
use Behastan202511\PhpParser\Internal\TokenStream;
use Behastan202511\PhpParser\Node\AttributeGroup;
...
use Behastan202511\PhpParser\Node\Expr\Cast;
use Behastan202511\PhpParser\Node\IntersectionType;
use Behastan202511\PhpParser\Node\MatchArm;
use Behastan202511\PhpParser\Node\Param;
use Behastan202511\PhpParser\Node\PropertyHook;
use Behastan202511\PhpParser\Node\Scalar;
use Behastan202511\PhpParser\Node\Stmt;
use Behastan202511\PhpParser\Node\UnionType;
