...
namespace Behastan202511\PhpParser\Node;

use Behastan202511\PhpParser\Modifiers;
use Behastan202511\PhpParser\Node\Expr\Assign;
use Behastan202511\PhpParser\Node\Expr\PropertyFetch;
use Behastan202511\PhpParser\Node\Expr\Variable;
use Behastan202511\PhpParser\Node\Stmt\Expression;
use Behastan202511\PhpParser\Node\Stmt\Return_;
use Behastan202511\PhpParser\NodeAbstract;
