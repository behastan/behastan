...
namespace Behastan202511\PhpParser;

/*
 * This parser is based on a skeleton written by Moriyoshi Koizumi, which in
 * turn is based on work by Masato Bito.
 */
use Behastan202511\PhpParser\Node\Arg;
use Behastan202511\PhpParser\Node\Expr;
use Behastan202511\PhpParser\Node\Expr\Array_;
use Behastan202511\PhpParser\Node\Expr\Cast\Double;
use Behastan202511\PhpParser\Node\Identifier;
use Behastan202511\PhpParser\Node\InterpolatedStringPart;
use Behastan202511\PhpParser\Node\Name;
use Behastan202511\PhpParser\Node\Param;
use Behastan202511\PhpParser\Node\PropertyHook;
use Behastan202511\PhpParser\Node\Scalar\InterpolatedString;
use Behastan202511\PhpParser\Node\Scalar\Int_;
use Behastan202511\PhpParser\Node\Scalar\String_;
use Behastan202511\PhpParser\Node\Stmt;
use Behastan202511\PhpParser\Node\Stmt\Class_;
use Behastan202511\PhpParser\Node\Stmt\ClassConst;
use Behastan202511\PhpParser\Node\Stmt\ClassMethod;
use Behastan202511\PhpParser\Node\Stmt\Const_;
use Behastan202511\PhpParser\Node\Stmt\Else_;
use Behastan202511\PhpParser\Node\Stmt\ElseIf_;
use Behastan202511\PhpParser\Node\Stmt\Enum_;
use Behastan202511\PhpParser\Node\Stmt\Interface_;
use Behastan202511\PhpParser\Node\Stmt\Namespace_;
use Behastan202511\PhpParser\Node\Stmt\Nop;
use Behastan202511\PhpParser\Node\Stmt\Property;
use Behastan202511\PhpParser\Node\Stmt\TryCatch;
use Behastan202511\PhpParser\Node\UseItem;
use Behastan202511\PhpParser\Node\VarLikeIdentifier;
use Behastan202511\PhpParser\NodeVisitor\CommentAnnotatingVisitor;
