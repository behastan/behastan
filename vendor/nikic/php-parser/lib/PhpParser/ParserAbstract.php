...
namespace Behastan202502\PhpParser;

/*
 * This parser is based on a skeleton written by Moriyoshi Koizumi, which in
 * turn is based on work by Masato Bito.
 */
use Behastan202502\PhpParser\Node\Arg;
use Behastan202502\PhpParser\Node\Expr;
use Behastan202502\PhpParser\Node\Expr\Array_;
use Behastan202502\PhpParser\Node\Expr\Cast\Double;
use Behastan202502\PhpParser\Node\Identifier;
use Behastan202502\PhpParser\Node\InterpolatedStringPart;
use Behastan202502\PhpParser\Node\Name;
use Behastan202502\PhpParser\Node\Param;
use Behastan202502\PhpParser\Node\PropertyHook;
use Behastan202502\PhpParser\Node\Scalar\InterpolatedString;
use Behastan202502\PhpParser\Node\Scalar\Int_;
...
use Behastan202502\PhpParser\Node\Stmt\ClassConst;
use Behastan202502\PhpParser\Node\Stmt\ClassMethod;
use Behastan202502\PhpParser\Node\Stmt\Else_;
use Behastan202502\PhpParser\Node\Stmt\ElseIf_;
use Behastan202502\PhpParser\Node\Stmt\Enum_;
use Behastan202502\PhpParser\Node\Stmt\Interface_;
use Behastan202502\PhpParser\Node\Stmt\Namespace_;
use Behastan202502\PhpParser\Node\Stmt\Nop;
use Behastan202502\PhpParser\Node\Stmt\Property;
use Behastan202502\PhpParser\Node\Stmt\TryCatch;
use Behastan202502\PhpParser\Node\UseItem;
use Behastan202502\PhpParser\Node\VarLikeIdentifier;
use Behastan202502\PhpParser\NodeVisitor\CommentAnnotatingVisitor;
