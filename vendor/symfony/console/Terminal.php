...
use Behastan202502\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('Behastan202502\shell_exec')) {
            return \false;
        }
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('Behastan202502\proc_open')) {
            return null;
        }
