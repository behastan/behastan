 ...
 */
namespace Behastan202511\Symfony\Component\String;

use Behastan202511\Symfony\Component\String\Exception\ExceptionInterface;
use Behastan202511\Symfony\Component\String\Exception\InvalidArgumentException;
use Behastan202511\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \JsonSerializable
{
    ...
    public function toByteString(?string $toEncoding = null): ByteString
    {
        ...
        try {
            ...
            if (!\function_exists('iconv') && !\function_exists('Behastan202511\iconv')) {
