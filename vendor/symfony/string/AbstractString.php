 ...
 */
namespace Behastan202502\Symfony\Component\String;

use Behastan202502\Symfony\Component\String\Exception\ExceptionInterface;
use Behastan202502\Symfony\Component\String\Exception\InvalidArgumentException;
use Behastan202502\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \JsonSerializable
{
     ...
     * @return static
     */
    abstract public function join(array $strings, ?string $lastGlue = null);
     ...
     * @return static
     */
    abstract public function padBoth(int $length, string $padStr = ' ');
    /**
     * @return static
     */
    abstract public function padEnd(int $length, string $padStr = ' ');
    /**
     * @return static
     */
    abstract public function padStart(int $length, string $padStr = ' ');
    /**
     * @return static
     */
     ...
     * @return static
     */
    abstract public function replace(string $from, string $to);
    /**
     * @param string|callable $to
     * @return static
     */
    abstract public function replaceMatches(string $fromRegexp, $to);
    /**
     * @return static
     */
     ...
     * @return static
     */
    abstract public function slice(int $start = 0, ?int $length = null);
    /**
     * @return static
     */
     ...
     * @return static
     */
    abstract public function splice(string $replacement, int $start = 0, ?int $length = null);
    /**
     * @return static[]
     */
     ...
     * @return static
     */
    abstract public function title(bool $allWords = \false);
    public function toByteString(?string $toEncoding = null): ByteString
    {
        ...
        try {
            ...
            if (!\function_exists('iconv') && !\function_exists('Behastan202502\iconv')) {
